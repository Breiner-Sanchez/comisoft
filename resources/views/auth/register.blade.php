...
<div class="container-fluid min-vh-100 d-flex align-items-center justify-content-center p-0" style="background: #f8fafc;">
    <div class="row w-100 m-0 justify-content-center py-5">
        <div class="col-12 col-md-8 col-lg-6 col-xl-5 animate__animated animate__zoomIn">
            <div class="card border-0 shadow-2xl rounded-5 overflow-hidden">
                <div class="card-body p-5">
                    <div class="text-center mb-5">
                        ...
                        <h3 class="fw-black tracking-tighter">Crear Cuenta</h3>
                        <p class="text-muted small">Regístrate para comenzar a gestionar actas</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="input-group-modern @error('name') border-danger @enderror">
                                    <i class="fas fa-user icon-left"></i>
                                    <input id="name" type="text" class="form-control-modern" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Juan Pérez">
                                </div>
                                @error('name')
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group-modern @error('email') border-danger @enderror">
                                    ...
                                    <input id="email" type="email" class="form-control-modern" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="nombre@correo.com">
                                </div>
                                @error('email')
                                    <span class="text-danger small mt-2 d-block fw-bold">
                                        <i class="fas fa-circle-exclamation me-1"></i> {{ $message }}
                ...
                <div class="bg-light p-4 text-center border-top">
                    <p class="small text-muted mb-0">¿Ya tienes una cuenta? <a href="{{ route('login') }}" class="text-primary fw-bold text-decoration-none">Inicia Sesión</a></p>
                </div>
            </div>
        </div>
    </div>
...
<style>
    ...
    /* Hide standard app sidebar/nav on register if needed */
